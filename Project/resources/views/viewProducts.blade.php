        ...
        <div class="col-md-2">
            <div id="sidebar" style="padding-left: 20px">
                ...
                <ul class="sidebar_menu">
                    <li><a class="text-decoration-none" href="{{route('product')}}">All</a></li>

                    @foreach($categories as $category)
                    <li><a class="text-decoration-none"
                            href="{{route('product',['category'=>$category->id])}}">{{$category->name}}</a></li>
                ...
                <div class="col col-md-3">
                    <div class="card h-100 ">
                        ...
                        <div class="card-body">
                            <a class="text-decoration-none"
                                ...
                                <img src="{{ asset('images/') }}/{{$product->image}}" width="100%"
                                    class="card-image-top" alt="Card image">
                            </a>
                        </div>
                        <div class="card-footer">
                            ...
                            <form action="{{route('add.to.cart')}}" method="post" class=".card-footer">
                                @csrf
                                <input type="hidden" name="quantity" value="1">
                                <input type="hidden" name="id" value="{{$product->id}}">
                                <button style="float:right;margin-right:10px;" class="btn btn-success btn-xs mr-2">Add
                                    to
                                    Cart</button>
                            </form>
                        </div>
